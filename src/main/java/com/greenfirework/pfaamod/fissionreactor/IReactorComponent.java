...
public interface IReactorComponent {
	 ...
	 * @param channelZ
	 */
	public void Source(FissionReactorController Context, int channelX, int channelZ);
	/**
	 ...
	 */
	public void Recieve(FissionReactorController Context, int sourceChannelX, int sourceChannelZ);
	/**
	 * Fired when the reactor is constructing itself.  Useful for reactor metadata (cooling surface area, etc)
	 * @param Context
	 */
	public void OnConstruct(FissionReactorController Context, int channelX, int channelZ);
}
